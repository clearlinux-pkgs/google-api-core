...
Source0  : https://files.pythonhosted.org/packages/0a/58/bd67f5fc6da38bd0a8d42eeb9d9f109e84b072b98409d1c9c860a0410bfb/google-api-core-2.2.2.tar.gz
...
%prep
%setup -q -n google-api-core-2.2.2
cd %{_builddir}/google-api-core-2.2.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636411149
...
cp %{_builddir}/google-api-core-2.2.2/LICENSE %{buildroot}/usr/share/package-licenses/google-api-core/2b8b815229aa8a61e483fb4ba0588b8b6c491890
