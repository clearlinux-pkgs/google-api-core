...
Source0  : https://files.pythonhosted.org/packages/42/53/e6c2b64337bdc4cbb3a0707ff2b0f7156a62c73f4fde3c8cd0b5d4c5f533/google-api-core-2.3.0.tar.gz
...
%prep
%setup -q -n google-api-core-2.3.0
cd %{_builddir}/google-api-core-2.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1638959974
...
cp %{_builddir}/google-api-core-2.3.0/LICENSE %{buildroot}/usr/share/package-licenses/google-api-core/2b8b815229aa8a61e483fb4ba0588b8b6c491890
