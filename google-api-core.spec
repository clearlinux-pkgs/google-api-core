...
Source0  : https://files.pythonhosted.org/packages/5c/64/30a91e03a7c80463d21423d81bf77116cffa02166d642f754b8fcb0df729/google-api-core-2.3.2.tar.gz
...
%prep
%setup -q -n google-api-core-2.3.2
cd %{_builddir}/google-api-core-2.3.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639677094
...
cp %{_builddir}/google-api-core-2.3.2/LICENSE %{buildroot}/usr/share/package-licenses/google-api-core/2b8b815229aa8a61e483fb4ba0588b8b6c491890
